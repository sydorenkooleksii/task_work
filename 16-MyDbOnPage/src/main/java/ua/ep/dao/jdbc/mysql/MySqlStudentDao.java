...
public class MySqlStudentDao implements StudentDao {
    ...
    public Student find(int id) {
        ...
        try (PreparedStatement query = connection
            ...
            //log
        	log.error("Something failed in find method", ex);
    ...
    public List<Student> findAll() {
        ...
        try (Statement query = connection.createStatement()) {
            ...
            //log
        	log.error("Something failed in findall method", ex);
            throw new RuntimeException(ex);
        }
        return result;
    }
    ...
    public void update(Student entity) {
        ...
        try (PreparedStatement query = connection
            ...
            //log
        	log.error("Something failed in update method", ex);
            throw new RuntimeException(ex);
        }
    }
    ...
    public void delete(int id) {
        ...
        try (PreparedStatement query = connection
            ...
            //log
        	log.error("Something failed in delete method", ex);
            throw new RuntimeException(ex);
        }
    }
    ...
    public void insert(Student entity) {
        ...
        try (PreparedStatement query = connection
            ...
            //log
        	log.error("Something failed in insert method", ex);
            throw new RuntimeException(ex);
        }
    }
    ...
    public List<Student> findByName(String name) {
        ...
        try (PreparedStatement query = connection
            ...
            ResultSet rs = query.executeQuery();
            while (rs.next()) {
                student.add(getStudentFromResultSet(rs));
            }
        } catch (Exception ex) {
            //log
        	log.error("Something failed in findByName method", ex);
            throw new RuntimeException(ex);
        }
        return student;
    }
